 ...
 */
final class Version20251203142627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gallery_image (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, category VARCHAR(50) DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL, created_at DATE DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE stylist_services (stylist_id INT NOT NULL, service_item_id INT NOT NULL, INDEX IDX_D0272BFF4066877A (stylist_id), INDEX IDX_D0272BFFDDEB00C2 (service_item_id), PRIMARY KEY (stylist_id, service_item_id)) DEFAULT CHARACTER SET utf8mb4');
